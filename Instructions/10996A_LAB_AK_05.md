...
6.  After **LON-HOST1** has restarted, login using the
...
6.  On the **The following Microsoft Account** will be used for **Azure Pass**
    page that opens, confirm your **Microsoft Account** details are correct, and
    then click **Confirm Microsoft Account.**
...
4.  On the W**elcome to Microsoft Azure** page that opens, click **Get Started
...
5.  In the **Settings for LON-OM1 on LON-HOST1** window that opens, from the
    details pane, click **Network Adapter** and then click **Add**.
...
11. On the **Azure Log Analytics** page, paste the **Workspace ID** copied in
    **Step 5** into the **Workspace ID** box, paste the **Primary Key** copied
    in **Step 5** into the **Workspace Key** box and then click **Next**.
...
5.  In the **Workspace prerequisite**s page that opens, in the **Automation
    Account** section, click **Use Existing** and then click
    **ContosoAutomation**.
