...
3.  In the **Log Search** blade that opens, close the **Search quick tips**
    popup window.

4.  Review the results that are returned.

5.  Review the query that was used to return the results.

6.  Edit the query to reflect the query below:
